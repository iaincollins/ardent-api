...
const MAX_MEMORY_SIZE_IN_BYTES = 1073741824 //  1GB
...
sqlLiteDatabases.pragma(`busy_timeout = ${BUSY_TIMEOUT_IN_MS}`)
// sqlLiteDatabases.pragma(`mmap_size = ${MAX_MEMORY_SIZE_IN_BYTES}`)
